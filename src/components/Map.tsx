...
export default function Map({
  ...
  return (
    ...
    >
      ...
      {/* Map style switcher */}
      <div className="absolute top-44 sm:top-auto sm:bottom-24 left-1/2 -translate-x-1/2 bg-gray-900/90 backdrop-blur-sm rounded-lg shadow-lg p-1 flex gap-1 z-40">
        <button
