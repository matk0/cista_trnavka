            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Bottom row with Navigovať and Nahlásiť sa */}
                  <div className="flex items-center justify-between mt-1.5 gap-2">
                    {event.meeting_point ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1 text-amber-500 hover:text-amber-400 text-xs sm:text-sm transition-colors"
                      >
